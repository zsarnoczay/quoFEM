...
cp -fr Examples ./build/Release/quoFEM.app/Contents/MacOS/
rm -fr ./build/Release/quoFEM.app/Contents/MacOS/Examples/.archive
rm -fr ./build/Release/quoFEM.app/Contents/MacOS/Examples/.aurore
rm -fr ./build/Release/quoFEM.app/Contents/MacOS/Examples/.gitignore
